...
public class TemplateFieldMappingSearchedResult {
    ...
    public TemplateFieldMappingSearchedResult(Long id, String templateCode, String templateSheetName, String headerName, String mappingFieldName) {
        this.id = id;
