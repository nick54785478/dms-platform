...
public class ValidationPolicyRetrievedResource {
    private Long id;
    private String code;
    ...
    // constructor
    public ValidationPolicyRetrievedResource(Long id, String code, String templateName, String templateSheetName, String mappingFieldName,
