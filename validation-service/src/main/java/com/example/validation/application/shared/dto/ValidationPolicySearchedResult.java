 ...
 * 列表查詢結果載體 DTO
 */
public class ValidationPolicySearchedResult {
    ...
    public ValidationPolicySearchedResult(Long id, String code, String templateName, String templateSheetName, String mappingFieldName,
